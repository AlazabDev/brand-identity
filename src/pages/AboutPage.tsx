...
const AboutPage = () => {
  return (
    <PageTransition>
      <PageMeta
        title="من نحن"
        description="تعرف على شركة Brand Identity - فريق من المهندسين والمصممين المتخصصين في تجهيز المحلات التجارية داخل المولات منذ 2010."
        canonical="https://brand-identity.alazab.com/about"
      />
