...
const ProjectsPage = () => {
  ...
  return (
    <PageTransition>
      <PageMeta
        title="معرض أعمالنا"
        description={`شاهد أكثر من ${totalImageCount} صورة لمشاريعنا المنفذة في كبرى المولات والمراكز التجارية - تجهيز محلات، ديكورات، واجهات.`}
        canonical="https://brand-identity.alazab.com/projects"
      />
          ...
          <section className="py-16 md:py-24 bg-primary text-primary-foreground">
            <div className="container-custom px-4 lg:px-8 text-center">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                <h1 className="font-display font-bold text-4xl md:text-5xl mb-4">معرض أعمالنا</h1>
            ...
            {lightboxIndex !== null && (
              ...
              >
                ...
                <motion.img
                  ...
                  alt={`مشروع ${lightboxIndex + 1} - تجهيز محل تجاري`}
